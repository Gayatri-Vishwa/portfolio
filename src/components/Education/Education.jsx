...
{/* <div className="absolute left-1/2 top-0 w-1 h-full bg-white -translate-x-1/2 hidden sm:block"></div> */}
        ...
        {education.map((edu, index) => (
          <div key={edu.id} className="relative w-full flex justify-center mb-16 mt-5">
            {/* Circle on line */}
                ...
                <div className="w-full sm:w-80  p-4 sm:p-6 rounded-2xl shadow-lg border border-white bg-gray-900 backdrop-blur-md">
                  ...
                  <div className="flex  items-center space-x-4 justify-end">
                    ...
                    <div className="flex flex-col justify-between">
                      ...
                      <p className="text-xs text-gray-500 mt-1">{edu.school2}</p>
                      <h4 className="text-sm sm:text-md text-gray-300">{edu.degree}{" "}{edu.date}</h4>
