    ...
    >
      <div className="text-white py-5 flex justify-between items-center">
        ...
        <div className="text-lg font-semibold cursor-pointer">
          ...
          <span className="text-white">Gayatri</span>
          <span className="text-[#8245ec]">/</span>
        ...
        <div className="absolute top-16 left-1/2 transform -translate-x-1/2 w-4/5 bg-[#050414] bg-opacity-50 backdrop-filter backdrop-blur-lg z-50 rounded-lg shadow-lg md:hidden">
          <ul className="flex flex-col items-center space-y-4 py-4 text-gray-300">
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="https://www.linkedin.com/in/gayatri-674412280"
...
//   //scroll and change navbar  bg
//   useEffect(() => {
//     const handleScroll = () => {
//       setIsScrolled(window, scrollY > 50); //checked IS window scrolled or not
//     };
...
//   return (
//     <nav
//       className={`fixed top-0 w-full  transition duration-300 px-[7vw] md:px-[12vw] lg:px-[20vw ${
//         isScrolled
...
//         <div className="hidden md:flex space-x-4">
//           <NavLink
//            to="https://github.com/gayatri-vishwa"
//             target="_blank"
//             rel="n00pener noreferrer"
//             className="text-gray-300 hover:text-[#8245ec]"
//           >
//             <FaGithub size={24} />
//           </NavLink>
...
//               </a>
//               <a
//                 href="https://www.linkedin.com/in/gayatri"
//                 target="_blank"
//                 rel="noopener noreferrer"
//                 className="text-gray-300 hover:text-white"
//               >
